pipeline {
  ...
  stages {
    stage('Build Docker Image') {
	 ...
	 docker build -t shivaproject2 .
         docker tag shivaproject2:latest $DOCKER_REGISTRY/shivaproject2:${BUILD_NUMBER}
         docker push $DOCKER_REGISTRY/shivaproject2:${BUILD_NUMBER}
	  '''
      }
    }
